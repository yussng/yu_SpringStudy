...
public class DataBoardRestController {
	...
	@PostMapping(value = "databoard/insert_vue.do",produces = "text/plain;cahrset=UTF-8")
	...
	// Vue / React => JSONP , 클로져
	@GetMapping(value = "databoard/list_vue.do",produces = "text/plain;cahrset=UTF-8")
	...
	@GetMapping(value = "databoard/page_vue.do",produces = "text/plain;cahrset=UTF-8")
