    ...
    <div class="content"> 
      ...
      <div id="gallery">
        <figure>
          ...
          <ul class="nospace clear">
            ...
            <a href="#"><img :src="vo.poster" :title="vo.chef" :style="width: 100%"></a></li>
          </ul>
        </figure>
      </div>
      <!-- ################################################################################################ --> 
      ...
      <nav class="pagination">
        <ul>
          ...
          <li v-for="i in range(startPage,endPage)" :class="i==curpage?'current':''"><a :href="../recipe/chef_find.do?chef='+vo.chef'" @click="pageChange(i)">{{i}}</a></li>
