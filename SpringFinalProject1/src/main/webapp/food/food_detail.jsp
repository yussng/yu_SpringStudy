    ...
    <div class="row">
      <div class="col-sm-8">
        <table class="table">
          ...
          <tr>
            <td colspan="2" class="text-right">
              <a :href="'../food/food_list.do?cno='+food_detail.cno" class="btn btn-sm btn-danger">목록</a>
            </td>
          </tr>
        </table>
            ...
            <td> 
              <table class="table" v-for="rvo in reply_list">
                ...
                <tr :id="'u'+rvo.no" class="updates" style="display:none">
	              <td colspan="2">
	                <textarea rows="4" cols="55" id="msg" style="float: left">{{rvo.msg}}</textarea>
	                <button style="float: left;background-color: blue;color: white;width: 100px;height: 88px" @click="replyUpdate(rvo.no,rvo.msg)">댓글수정</button>
	              </td>
	            </tr>
              </table>
            </td>
        ...
        <table class="table" v-if="sessionId!=''">
          <tr>
            <td>
              <textarea rows="4" cols="58" ref="msg" v-model="msg" style="float: left"></textarea>
              <button style="float: left;background-color: blue;color: white;width: 100px;height: 88px" @click="replyWrite()">댓글쓰기</button>
            </td>
          </tr>
        </table>
      </div>
