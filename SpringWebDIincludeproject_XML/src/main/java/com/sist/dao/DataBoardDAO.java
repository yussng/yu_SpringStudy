...
public class DataBoardDAO {
	...
	@Insert("INSERT INTO springDataBoard(no,time,usbject,content,pwd,filename,filesize,filecount "
	...
	@Select("SELECT no,name,subject,content,hit,TO_CHAR(regdatd,'YYYY-MM-DD') as dbday, "
