                            ...
                            <div class="main-menu  d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">
                                        ...
                                        <li><a href="../product/productList.jsp">.zip 스토어</a>
                                            <ul class="submenu">
                                                <li><a href="../shionhouse-master/blog.html">가구</a></li>
                                                <li><a href="../shionhouse-master/blog_details.html">패브릭</a></li>
                                                <li><a href="../shionhouse-master/elements.html">조명</a></li>
                                            </ul>
                                        </li>
